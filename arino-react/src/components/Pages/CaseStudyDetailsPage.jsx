  ...
  return (
    <>
      <PageHeading
        ...
        pageLinkText="VIP Details"
      />
      <Spacing lg="145" md="80" />
      <Div className="container">
        <SectionHeading
          title="Importance of receiving the proper guidance and getting the right support"
        ...
        <h2 className="cs-font_38 text-center">Amazon Overview</h2>
        <Spacing lg="60" md="45" />
        <p className="cs-m0">
      ...
      <Div className="cs-gradient_bg_1 cs-shape_wrap_6">
        ...
        <Div className="container">
          <Spacing lg="145" md="80" />
          <h2 className="cs-font_38 text-center">Study Research</h2>
          <Spacing lg="90" md="45" />
          <Div className="row align-items-center cs-column_reverse_lg">
            <Div className="col-lg-5">
              <h3 className="cs-font_30 cs-m0">Product search</h3>
              <Spacing lg="45" md="30" />
              <p className="cs-m0">
          ...
          <Div className="row align-items-center">
            ...
            <Div className="col-lg-5 offset-lg-1">
              <h3 className="cs-font_30 cs-m0">Listing guidelines</h3>
              <Spacing lg="45" md="30" />
              <p className="cs-m0">
                Our goal perspiciatis unde omnis iste natus error sit voluptatem
                bolaru accusantium voltire doloremque laudantium, totam rem
      ...
      <Div className="container text-center">
        <Div className="row col-lg-10 offset-lg-1">
          <h2 className="cs-font_38 cs-m0">Result of The Vip Package</h2>
          <Spacing lg="60" md="45" />
          <p className="cs-m0">
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem
            accusantium voltire doloremque laudantium, totam rem aperiam, eaque
